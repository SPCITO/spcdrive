        ...
        <table className="w-full text-left border-separate border-spacing-y-2">
          <thead>
            <tr className="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-400">
              <th className="pb-2 pl-4">File Name</th>
              ...
              {files.length > 0 ? (
                files.map((file, idx) => (
                  <motion.tr 
                    ...
                    className="group bg-zinc-50/50 hover:bg-white border border-zinc-100 transition-shadow duration-300 hover:shadow-md hover:shadow-zinc-200/20"
                  >
                    <td className="py-4 pl-4 rounded-l-2xl border-y border-l border-zinc-100 group-hover:border-emerald-200/50 transition-colors">
                    ...
                    <td className="py-4 text-xs font-mono text-zinc-500 border-y border-zinc-100 group-hover:border-emerald-200/50 transition-colors">
                      {file.size}
                    </td>
                    <td className="py-4 border-y border-zinc-100 group-hover:border-emerald-200/50 transition-colors">
                    ...
                    <td className="py-4 text-right pr-4 rounded-r-2xl border-y border-r border-zinc-100 group-hover:border-emerald-200/50 transition-colors">
