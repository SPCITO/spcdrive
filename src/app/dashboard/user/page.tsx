...
import { Loader2, ShieldCheck, DownloadCloud, HardDrive } from 'lucide-react';
...
export default function UserDashboard() {
  ...
  return (
    <DashboardShell 
      // Dynamic Title to match Admin style
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-6 gap-6">
        ...
        {/* --- QUICK STATS CARD (Filling the md:col-span-2) --- */}
        ...
        <div className="md:col-span-6">
          <BentoCard title="Operative Repository">
            <FileBank 
              ...
              onDownload={(file: any) => alert(`Initializing secure retrieval for ${file.name}`)}
              onUpdate={() => {}} 
              onDelete={() => {}}
            />
          </BentoCard>
